...
public final class LibreOfficeKit
{
    ...
    public static synchronized void init(Activity activity)
    {
        ...
        if (!initializeNative(dataDir, cacheDir, apkFile, mgr)) {
            // Dokumenty modification: fail safely instead of continuing with an invalid handle.
            throw new IllegalStateException("Nie udało się zainicjować silnika LibreOffice.");
        }
        initializeDone = true;
    }
